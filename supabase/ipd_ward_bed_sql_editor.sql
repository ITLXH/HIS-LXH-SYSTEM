...
CREATE TABLE IF NOT EXISTS public."HIS_One_Beds" (
  ...
  "Current_Patient_HN" TEXT,
  "Current_IPD_Admission_ID" TEXT,
...
ALTER TABLE public."HIS_One_Wards" ADD COLUMN IF NOT EXISTS "Ward_Type" TEXT DEFAULT 'General';
ALTER TABLE public."HIS_One_Wards" ADD COLUMN IF NOT EXISTS "Description" TEXT;
ALTER TABLE public."HIS_One_Wards" ADD COLUMN IF NOT EXISTS "Updated_At" TIMESTAMPTZ DEFAULT NOW();

ALTER TABLE public."HIS_One_Rooms" ADD COLUMN IF NOT EXISTS "Floor" TEXT;
ALTER TABLE public."HIS_One_Rooms" ADD COLUMN IF NOT EXISTS "Daily_Charge" NUMERIC DEFAULT 0;
ALTER TABLE public."HIS_One_Rooms" ADD COLUMN IF NOT EXISTS "Description" TEXT;
ALTER TABLE public."HIS_One_Rooms" ADD COLUMN IF NOT EXISTS "Updated_At" TIMESTAMPTZ DEFAULT NOW();

ALTER TABLE public."HIS_One_Beds" ADD COLUMN IF NOT EXISTS "Bed_Type" TEXT DEFAULT 'Standard';
ALTER TABLE public."HIS_One_Beds" ADD COLUMN IF NOT EXISTS "Bed_Status" TEXT DEFAULT 'Available';
ALTER TABLE public."HIS_One_Beds" ADD COLUMN IF NOT EXISTS "Current_Patient_ID" TEXT;
ALTER TABLE public."HIS_One_Beds" ADD COLUMN IF NOT EXISTS "Current_Patient_HN" TEXT;
ALTER TABLE public."HIS_One_Beds" ADD COLUMN IF NOT EXISTS "Current_IPD_Admission_ID" TEXT;
ALTER TABLE public."HIS_One_Beds" ADD COLUMN IF NOT EXISTS "Last_Status_Updated_At" TIMESTAMPTZ DEFAULT NOW();
ALTER TABLE public."HIS_One_Beds" ADD COLUMN IF NOT EXISTS "Updated_At" TIMESTAMPTZ DEFAULT NOW();

ALTER TABLE public."HIS_One_Admissions" ADD COLUMN IF NOT EXISTS "Updated_At" TIMESTAMPTZ DEFAULT NOW();
